...
#  EMAIL — Configuration
# ─────────────────────────────────────────────────────────────────────────────
# En développement, le code OTP s'affiche dans les logs Docker (docker compose logs backend).
# En production, définir EMAIL_HOST, EMAIL_PORT, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, etc.
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "noreply@cpharma.tn")
